...
def magic_workshop():
    return render_template('learning/magic_workshop_improved.html')

@app.route('/learning/magic_workshop_phase2')
def magic_workshop_phase2():
    return render_template("learning/magic_workshop_enhanced.html")
